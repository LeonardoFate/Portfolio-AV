...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm('service_qfb81lj', 'template_imbmwzm', form.current, 'Q9iB67kl-vEderODW')
   e.target.reset();
  };
  return (
      ...
      <div className="contact__content">
        ...
        <form ref={form} onSubmit={sendEmail} className="contact__form">
          ...
          <div className="contact__form-div">
            ...
            <input type="email" name="email" className='contact__form-input' placeholder='Escribe tu email'/>
          </div>
          <div className="contact__form-div contact_form-area">
            <label  className='contact__form-tag'>Projecto</label>
            <textarea name="project" cols="30" rows="10" className='contact__form-input' placeholder='Escribeme tu projecto'></textarea>
          </div>
